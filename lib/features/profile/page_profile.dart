              ...
              Container(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Text(
                      controller.controllerGlobalUser.user.value.email ?? 'user@email.com',
                      style: const TextStyle(
                        fontSize: 14,
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            "Hello, i am a ${controller.controllerGlobalUser.user.value.division ?? 'Division'}",
                            style: const TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.w300,
                                fontFamily: 'ComicSans'
                    ...
                    ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          ...
                          fixedSize: Size(Get.width * 0.8.w, 45),
                        ),
                        child: const Text(
                          'Change Password',
                          style: TextStyle(
